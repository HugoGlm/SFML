...
void Test::DoubleTest::Test()
{
	...
	checkLow((_c == 15.0), "c is not equal to 15")
		checkLow((_c != _a), "c is not != to a")
		checkLow((_b >= _c), "b is not >= to c")
		checkLow((_a <= _c), "a is not <= to c")

		Engine::PrimaryType::Double _d = _a + _b;
	checkLow((_d == 25.0), "d is not equals ta a + b = 25")
		_d = _b - _a;
	checkLow((_d == 5.0), "d is not equals to b - a = 5")
		_d = _a * _b;
	checkLow((_d == 150.0), "d is not equals to b * a = 150")
		_d = _a / 2.0;
	checkLow((_d == 5.0), "d is not equals to a / 2 = 5")
		_d += 250.0;
	checkLow((_d == 255.0), "d is not equals to d += 250 = 260")
		_d -= 30.0;
	checkLow((_d == 225.0), "d is not equals to d -= 30 = 230")
		_d *= 2.0;
	checkLow((_d == 450.0), "d is not equals to d *= 2 = 460")
		_d /= 4.0;
	checkLow((_d == 112.5), "d is not equals to d /= 4 = 115")
